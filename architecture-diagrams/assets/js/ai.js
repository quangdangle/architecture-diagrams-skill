...
var AI_OPS_DOC = [
  ...
  '- addNote {note: {text, kind, attach}}: a sticky note; kind is note, constraint, reason, change, question, todo or legend; attach is a block or frame id or [from, to]. Do not add a note of kind change about your own answer: the tool keeps your summary as that note. When you remove or reroute a wire or block a note is attached to, attach the note to what replaces it (updateNote).',
